...
public class RolesRecord extends UpdatableRecordImpl<RolesRecord> implements Record2<Integer, String> {
    ...
    /**
     * Setter for <code>evidennewsaggregator.roles.id</code>.
     */
    ...
    /**
     * Getter for <code>evidennewsaggregator.roles.id</code>.
     */
     ...
     * Create a detached, initialised RolesRecord
     */
    public RolesRecord(com.example.EvidenNewsAggregator.entities.tables.pojos.Roles value) {
        super(Roles.ROLES);
