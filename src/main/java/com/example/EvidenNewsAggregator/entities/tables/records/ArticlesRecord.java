...
public class ArticlesRecord extends UpdatableRecordImpl<ArticlesRecord> implements Record11<Integer, String, LocalDate, String, Integer, String, String, Byte, String, Integer, Integer> {
    ...
    /**
     * Setter for <code>evidennewsaggregator.articles.id</code>.
     */
    public ArticlesRecord setId(Integer value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>evidennewsaggregator.articles.id</code>.
     */
     ...
     */
    public ArticlesRecord(Integer id, String title, LocalDate date, String description, Integer rating, String sourceLink, String name, Byte approved, String image, Integer categoryId, Integer userId) {
        super(Articles.ARTICLES);
     ...
     * Create a detached, initialised ArticlesRecord
     */
    public ArticlesRecord(com.example.EvidenNewsAggregator.entities.tables.pojos.Articles value) {
        super(Articles.ARTICLES);
