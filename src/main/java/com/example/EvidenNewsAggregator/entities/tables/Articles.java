...
public class Articles extends TableImpl<ArticlesRecord> {
    ...
    /**
     * The column <code>evidennewsaggregator.articles.id</code>.
     */
    ...
    /**
     * Create an aliased <code>evidennewsaggregator.articles</code> table
     * reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ARTICLES_CATEGORY_ID_IDX, Indexes.ARTICLES_USER_ID_IDX);
    }
    ...
    public List<UniqueKey<ArticlesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_ARTICLES_ID_UNIQUE);
    }

    @Override
    public List<ForeignKey<ArticlesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CATEGORY_ID, Keys.USER_ID);
    }
     ...
     * <code>evidennewsaggregator.categories</code> table.
     */
    ...
    /**
     * Get the implicit join path to the <code>evidennewsaggregator.users</code>
     * table.
     */
    public Users users() {
        if (_users == null)
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Integer, ? super String, ? super LocalDate, ? super String, ? super Integer, ? super String, ? super String, ? super Byte, ? super String, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super Integer, ? super String, ? super LocalDate, ? super String, ? super Integer, ? super String, ? super String, ? super Byte, ? super String, ? super Integer, ? super Integer, ? extends U> from) {
