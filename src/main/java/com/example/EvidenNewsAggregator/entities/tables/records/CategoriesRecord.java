...
public class CategoriesRecord extends UpdatableRecordImpl<CategoriesRecord> implements Record2<Integer, String> {
    ...
    /**
     * Setter for <code>evidennewsaggregator.categories.id</code>.
     */
    ...
    /**
     * Getter for <code>evidennewsaggregator.categories.id</code>.
     */
     ...
     * Create a detached, initialised CategoriesRecord
     */
    public CategoriesRecord(com.example.EvidenNewsAggregator.entities.tables.pojos.Categories value) {
        super(Categories.CATEGORIES);
