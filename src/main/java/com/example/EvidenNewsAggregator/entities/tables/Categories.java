...
public class Categories extends TableImpl<CategoriesRecord> {
    ...
    /**
     * The column <code>evidennewsaggregator.categories.id</code>.
     */
    ...
    /**
     * Create an aliased <code>evidennewsaggregator.categories</code> table
     * reference
     */
    ...
    public List<UniqueKey<CategoriesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_CATEGORIES_ID_UNIQUE);
    }
